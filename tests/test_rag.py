...
def test_retriever_overfetches_candidates_for_dedupe() -> None:
    ...
    # Exactly k x the over-fetch factor: the v2 HNSW index needs no wider candidate pool.
    # The eval's index check guards this (0 of 28 gold questions miss a true neighbour).
